...
#ifdef CONFIG_MACH_MSM8974_G2_DCM   //for l01f
#include "L01F_D80x_FLSVS_driver/SynaImage_for_G2_LGIT_revB.h"
#include "L01F_D80x_FLSVS_driver/SynaImage_for_G2_TPK.h"
#else
